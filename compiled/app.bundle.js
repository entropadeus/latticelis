...
var NAV = [{
  ...
  children: [{
    ...
    label: 'System Setup',
    icon: 'IconShield',
    anyPermission: ['RESTORE_SNAPSHOT', 'EDIT_LAB_CONFIG']
  }, {
    kind: 'item',
    id: 'billing',
    label: 'Billing',
    ...
    label: 'Customization',
    icon: 'IconLabel',
    anyPermission: ['EDIT_LABEL_TEMPLATES', 'EDIT_LAB_CONFIG', 'EDIT_TEST_CATALOG']
  }, {
    kind: 'item',
    id: 'interfaces',
    label: 'Device Engine Setup',
    icon: 'IconInterface',
    ...
    label: 'Other Setup',
    icon: 'IconMap',
    anyPermission: ['EDIT_LAB_CONFIG', 'EDIT_INTERFACES']
  }, {
    kind: 'item',
    id: 'patient-setup',
    label: 'Patient Setup',
    ...
    label: 'Manage',
    icon: 'IconList',
    anyPermission: ['RESOLVE_QC', 'EDIT_INTERFACES']
  }, {
    kind: 'item',
    id: 'monitor',
    label: 'Monitor',
    icon: 'IconInstrument',
    anyPermission: ['EDIT_INTERFACES', 'EDIT_LAB_CONFIG']
  }]
}];
var __flattenNav = tree => {
  var out = [];
  var walk = nodes => nodes.forEach(n => {
    if (n.kind === 'section') walk(n.children || []);else out.push(n);
  });
  walk(tree);
  return out;
};
...
var NavSection = ({
  ...
  if (collapsed) {
    ...
    }, visibleChildren.map(item => React.createElement(NavItemButton, {
      key: item.id,
      item: item,
      active: active,
      onNav: onNav,
  ...
  }, React.createElement("div", null, visibleChildren.map(item => React.createElement(NavItemButton, {
    key: item.id,
    item: item,
    active: active,
    onNav: onNav,
...
var Sidebar = ({
  ...
  var [sectionState, setSectionState] = useState(() => {
  ...
  useEffect(() => {
    var sec = NAV.find(n => n.kind === 'section' && (n.children || []).some(c => c.id === active));
  ...
  return React.createElement("aside", {
    ...
    if (node.kind === 'item') {
      ...
      return React.createElement(NavItemButton, {
        key: node.id,
        item: node,
        active: active,
        onNav: onNav,
    ...
    if (node.kind === 'section') {
      if (!__navItemAllowed(node)) return null;
      return React.createElement(NavSection, {
        key: node.id,
        section: node,
...
var UniversalSearch = ({
  ...
  var matches = useMemo(() => {
    ...
    if (!term) return [];
    var hit = s => (s || '').toLowerCase().includes(term);
    var out = [];
    var push = (m, cap) => {
  ...
  return React.createElement("div", {
  ...
  }, "\u2318K")), showPanel && React.createElement(React.Fragment, null, React.createElement("div", {
  ...
  }, "No matches for ", React.createElement("span", {
    className: "mono"
  ...
  }, "Try a patient name, MRN, accession, order number, or test code.")) : Object.entries(grouped).map(([kind, list]) => React.createElement("div", {
    key: kind,
    style: {
      marginBottom: 6
    }
    ...
    }, m.sub)), isActive && React.createElement(IconArrowRight, {
      size: 12,
      style: {
        color: 'var(--ink-400)'
      }
    ...
    className: "kbd"
  }, "\u21B5"), " open"), React.createElement("span", null, React.createElement("span", {
    className: "kbd"
  }, "esc"), " close"), React.createElement("span", {
    style: {
      flex: 1
    }
  }), React.createElement("span", null, React.createElement("span", {
...
var Topbar = ({
  ...
  }, React.createElement(UniversalSearch, {
    onNav: onNav
  }), React.createElement("div", {
    style: {
      flex: 1
...
var CommandPalette = ({
  ...
  var items = useMemo(() => {
    var all = [...NAV_FLAT.filter(__navItemAllowed).map(n => ({
      id: 'nav-' + n.id,
      label: 'Go to ' + n.label,
      kind: 'Navigate',
      target: n.id
...
var TestCatalogPage = ({
  ...
  return React.createElement(Page, {
  ...
  }), React.createElement("th", null, "Code"), React.createElement("th", null, "Name"), React.createElement("th", null, "LOINC"), React.createElement("th", null, "Units"), React.createElement("th", null, "Dept"), React.createElement("th", null, "Ref range"), React.createElement("th", null, "TAT"), React.createElement("th", {
    style: {
      width: 100
    }
    ...
    style: {
      color: t.department ? 'var(--ink-600)' : 'var(--ink-300)',
      fontSize: 11.5
    }
  }, t.department ? t.department.replace('Anatomic Pathology', 'AP').replace('Microbiology', 'Micro').replace('Hematology', 'Heme').replace('Chemistry', 'Chem').replace('Molecular', 'Mol').replace('Toxicology', 'Tox').replace('Cytology', 'Cyto') : '—'), React.createElement("td", {
    className: "mono tnum",
    style: {
      color: 'var(--ink-500)'
    }
    ...
    value: ""
  }, "\u2014 unassigned \u2014"), ['Chemistry', 'Hematology', 'Microbiology', 'Molecular', 'Toxicology', 'Cytology', 'Anatomic Pathology'].map(d => React.createElement("option", {
    key: d,
    value: d
...
var ClientsPage = ({
  ...
  }, filtered.length, " of ", clients.length)), filtered.length > 0 && React.createElement(TablePagination, _extends({}, pager, {
    pos: "top"
  })), React.createElement("div", {
    style: {
      flex: 1,
  ...
  }))), React.createElement("tbody", null, pager.slice.map(c => React.createElement("tr", {
    key: c.id,
    style: {
...
var LocationsPage = ({
  ...
  }, filtered.length, " of ", all.length)), filtered.length > 0 && React.createElement(TablePagination, _extends({}, pager, {
    pos: "top"
  })), React.createElement("div", {
    style: {
      flex: 1,
  ...
  }))), React.createElement("tbody", null, pager.slice.map(l => React.createElement("tr", {
    key: l.id,
    style: {
...
`;
  ...
  return React.createElement(Page, {
    ...
    className: "empty-sub"
  }, "Click \"New mapper\" to start.")) : pager.slice.map(m => {
...
var {
  useState: useStateOR,
  useEffect: useEffectOR
} = React;
var OutreachBucketPage = ({
  title,
  sub,
  tiles,
  onNav,
  ...
  return React.createElement(Page, {
    ...
    className: "empty-title"
  }, "Nothing wired up here yet"), React.createElement("div", {
    className: "empty-sub"
  }, "This bucket exists so the Outreach-style navigation reads complete. Sub-pages will land here as the matching feature ships.")) : React.createElement("div", {
    className: "stagger-children",
    style: {
      display: 'grid',
      gridTemplateColumns: 'repeat(2, 1fr)',
...
var ThisLocationPage = ({
  onNav
}) => {
  var orders = window.useEntities('orders');
  var specimens = window.useEntities('specimens');
  var locations = window.useEntities('locations');
  var activeLoc = (locations || []).find(l => l.active !== false) || (locations || [])[0] || null;
  var locId = activeLoc && activeLoc.id;
  var myOrders = (orders || []).filter(o => !locId || o.locationId === locId);
  var mySpecs = (specimens || []).filter(s => !locId || s.locationId === locId);
  return React.createElement(Page, {
    label: "This Location"
  }, React.createElement(PageHeader, {
    title: "This Location",
    ...
    v: myOrders.filter(o => o.status !== 'completed' && o.status !== 'cancelled').length,
    go: 'results'
  }, {
    l: 'Active location',
    v: activeLoc ? activeLoc.name || activeLoc.code : '—'
  }].map((s, i, arr) => React.createElement("button", {
    key: s.l,
    onClick: () => s.go && onNav && onNav(s.go),
    style: {
      padding: '14px 16px',
    ...
    onMouseEnter: e => {
      if (s.go) e.currentTarget.style.background = 'var(--ivory-100)';
    },
    onMouseLeave: e => {
    ...
    className: "empty-title"
  }, "Deeper location queues land next"), React.createElement("div", {
    className: "empty-sub"
  }, "Pickups due, courier route, location-scoped activity feed.")));
};
var PreferencesPage = () => {
  var cur = window.currentUser || {};
  return React.createElement(Page, {
  ...
  }, "Identity"), React.createElement("div", {
    style: {
      display: 'grid',
  ...
  }, [cur.firstName, cur.lastName].filter(Boolean).join(' ') || cur.username || '—')), React.createElement("div", null, React.createElement("div", {
    style: {
      fontSize: 11,
      color: 'var(--ink-400)'
    }
  ...
  }, cur.username || '—')), React.createElement("div", null, React.createElement("div", {
    style: {
      fontSize: 11,
      color: 'var(--ink-400)'
    }
  ...
  }, cur.email || '—')))), React.createElement("div", {
    className: "empty",
    style: {
      padding: '40px 24px'
    }
    ...
    className: "empty-title"
  }, "More preferences land next"), React.createElement("div", {
    className: "empty-sub"
...
var CustomizationPage = ({
  ...
  tiles: [{
    id: 'labels',
    label: 'Labels & Printing',
    desc: 'ZPL templates, printer formats',
    icon: 'IconLabel',
    go: 'labels',
    permission: 'EDIT_LABEL_TEMPLATES'
  }, {
    id: 'notifications',
    label: 'Notifications',
    desc: 'TAT thresholds, alert routing',
    icon: 'IconBell',
    go: 'notifications',
    permission: 'EDIT_LAB_CONFIG'
  }, {
...
var OtherSetupPage = ({
  ...
  tiles: [{
    ...
    id: 'clients',
    label: 'Clients',
    desc: 'Referring clinics, delivery prefs',
    icon: 'IconMap',
    go: 'clients',
    permission: 'EDIT_LAB_CONFIG'
  }, {
...
var MonitorPage = ({
  ...
  tiles: [{
    id: 'instruments',
    label: 'Instruments',
    desc: 'Connected devices, live status',
    icon: 'IconInstrument',
    go: 'instruments',
    permission: 'EDIT_INTERFACES'
  }, {
    ...
    id: 'reports',
    label: 'Activity log',
    desc: 'Audit trail across the system',
    icon: 'IconReports',
    go: 'reports'
  }]
});
...
var App = () => {
  ...
  var activePage = useMemoApp(() => {
    switch (active) {
      ...
      case 'preferences':
        return React.createElement(window.PreferencesPage, null);
      case 'admin-reports':
        return React.createElement(window.AdminReportsPage, {
          onNav: setActive
        });
      case 'system-setup':
      ...
      case 'customization':
        return React.createElement(window.CustomizationPage, {
          onNav: setActive
        });
      case 'insurance':
        return React.createElement(window.InsurancePage, {
          onNav: setActive
        });
      case 'other-setup':
        return React.createElement(window.OtherSetupPage, {
          onNav: setActive
        });
      case 'patient-setup':
        return React.createElement(window.PatientSetupPage, {
          onNav: setActive
        });
      case 'toxicology':
        return React.createElement(window.ToxicologyPage, {
          onNav: setActive
        });
      case 'manage':
        return React.createElement(window.ManagePage, {
      ...
      case 'monitor':
        return React.createElement(window.MonitorPage, {
          onNav: setActive
        });
      default:
        return React.createElement(DashboardPage, null);
